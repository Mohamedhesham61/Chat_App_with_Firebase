  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xff003944),
        title: Row(
          children: [
            Image.asset(
              "assets/images/chaticon.jpg",
              height: 25,
            ),
            const SizedBox(
              width: 10,
      ...
      child: Column(
        ...
        children: [
          ...
          Material(
            ...
            color: isMe ? const Color(0xff003944) : const Color(0xFFfffe58),
            child: Padding(
              padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 20),
              child: Text(
                '$text',
                style: TextStyle(
                    fontSize: 15, color: isMe ? Colors.white : Colors.blueGrey),
              ),
            ),
          ),
        ],
